...
- [~] TD-004: перевести обогащение изображений в строго ручной режим с
...
- **Статус:** `[~]` код подготовлен, ожидает release gate.
...
- **Release gate:** миграция, targeted/backend CI, production deploy и проверка
  отсутствия старого beat-расписания.
