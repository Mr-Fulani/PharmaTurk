# Архив: ТЗ по SEO-индексации и производительности Mudaroba

> **Архивный документ.** Это историческое ТЗ и отчёт о выполнении работ на
> 2026-06-12, а не актуальная инструкция по разработке или деплою. Указанные ниже
> версии Next.js/Node.js, ветки, результаты тестов, замеры и номера строк сохранены
> как контекст выполненной работы и со временем могут не совпадать с проектом.
> Операционные источники правды: `docs/DEVELOPMENT_RULES.md`, текущие
> `frontend/package.json` и `backend/pyproject.toml`, `.github/workflows/ci.yml`,
> конфигурация Nginx и фактический код.
...
> **Статус (2026-06-12):**
> - Этапы 1–3 ✅ — ветка `seo/p0-locale-redirects`. Поправка по фактам: `/ru/*`
>   в Next 14 — 200-дубликат, а не 404; добавлен 301 на nginx (в Next не
