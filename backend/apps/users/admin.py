...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('username', 'first_name', 'last_name', 'middle_name', 'phone_number', 'birth_date')}),
        (_('Address'), {'fields': ('country', 'city', 'postal_code', 'address')}),
        (_('Contacts'), {'fields': ('whatsapp_phone', 'telegram_username')}),
