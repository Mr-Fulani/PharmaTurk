    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("crypto_payment_text", models.CharField(blank=True, default="Возможна оплата криптовалютой", max_length=200, verbose_name="Текст про оплату криптовалютой")),
