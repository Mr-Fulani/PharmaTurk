...
def create_furniture_base_products(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("catalog", "0101_add_is_new_to_specialized_products"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(create_furniture_base_products, migrations.RunPython.noop),
    ]
