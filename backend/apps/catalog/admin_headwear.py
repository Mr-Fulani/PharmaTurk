...
class HeadwearVariantInline(AdminMediaHelpTextMixin, admin.TabularInline):
...
class HeadwearProductImageInline(AdminMediaHelpTextMixin, admin.TabularInline):
...
class HeadwearVariantImageInline(AdminMediaHelpTextMixin, admin.TabularInline):
...
class HeadwearVariantAdmin(AdminMediaHelpTextMixin, VariantAIAdminMixin, admin.ModelAdmin):
    list_display = (
...
class HeadwearProductAdmin(AdminMediaHelpTextMixin, ShadowProductCleanupAdminMixin, RunAIActionMixin, admin.ModelAdmin):
