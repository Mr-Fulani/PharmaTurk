...
class UnderwearVariantInline(AdminMediaHelpTextMixin, admin.TabularInline):
...
class UnderwearProductImageInline(AdminMediaHelpTextMixin, admin.TabularInline):
...
class UnderwearVariantImageInline(AdminMediaHelpTextMixin, admin.TabularInline):
...
class UnderwearVariantAdmin(AdminMediaHelpTextMixin, VariantAIAdminMixin, admin.ModelAdmin):
    list_display = (
...
class UnderwearProductAdmin(AdminMediaHelpTextMixin, ShadowProductCleanupAdminMixin, RunAIActionMixin, admin.ModelAdmin):
