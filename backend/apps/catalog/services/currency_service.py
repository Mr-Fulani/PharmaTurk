...
class CurrencyRateService:
    ...
    # Базовые валюты для каждого источника
    BASE_CURRENCIES = {
        'centralbank_rf': 'RUB',
        'nationalbank_kz': 'KZT', 
        'centralbank_tr': 'TRY',
    ...
    def get_rates_from_source(self, source: str) -> Dict[str, Decimal]:
        """Получение курсов из указанного источника"""
    ...
    def _parse_openexchangerates_response(self, data: Dict) -> Dict[str, Decimal]:
        """Парсинг ответа OpenExchangeRates"""
        rates = {}
    ...
    def _parse_nbk_response(self, xml_data: str) -> Dict[str, Decimal]:
        """Парсинг ответа Национального банка Казахстана"""
    ...
    def _parse_tcmb_response(self, xml_data: str) -> Dict[str, Decimal]:
        """Парсинг ответа Центробанка Турции"""
        from xml.etree import ElementTree as ET
    ...
    def update_rates(self, source: str = None) -> Tuple[bool, str]:
        ...
        if source is None:
            # Используем основной источник с fallback
