...
class IslamicClothingVariantInline(admin.TabularInline):
...
class IslamicClothingProductImageInline(admin.TabularInline):
...
class IslamicClothingVariantImageInline(admin.TabularInline):
...
class IslamicClothingVariantAdmin(VariantAIAdminMixin, admin.ModelAdmin):
    list_display = (
...
class IslamicClothingProductAdmin(ShadowProductCleanupAdminMixin, RunAIActionMixin, admin.ModelAdmin):
