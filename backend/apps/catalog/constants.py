...
# поэтому они не зависят от переименований категорий на стороне IKEA.
FURNITURE_SUBCATEGORIES = [
    (
        ...
        [
            ...
            ("Диваны-кровати", "Sofa Beds", "sofa-beds", "Раскладные диваны и диваны-кровати", "Sofa beds"),
            ("Модульные диваны", "Modular Sofas", "modular-sofas", "Модульные диваны", "Modular sofas"),
            ("Кресла", "Armchairs", "armchairs", "Кресла", "Armchairs"),
            ("Кресла-качалки", "Rocking Chairs", "rocking-armchairs", "Кресла-качалки", "Rocking chairs"),
            ("Пуфы", "Pouffes", "pouffes", "Пуфы и подставки для ног", "Pouffes and footstools"),
            ...
            ("Буфеты и серванты", "Sideboards and Buffets", "sideboards", "Буфеты и серванты", "Sideboards and buffets"),
            ("Консольные столы", "Console Tables", "console-tables", "Консольные столы", "Console tables"),
        ],
    ),
    (
        "Спальня",
        ...
        [
            ...
            ("Кровати с хранением", "Storage Beds", "storage-beds", "Кровати со встроенным хранением", "Beds with storage"),
            ("Кушетки", "Day Beds", "day-beds", "Кушетки и раздвижные кровати", "Day beds"),
            ("Матрасы", "Mattresses", "mattresses", "Матрасы", "Mattresses"),
            ("Основания кроватей", "Bed Bases", "bed-bases", "Основания и реечные днища кроватей", "Bed bases"),
            ...
            ("Туалетные столики", "Dressing Tables", "dressing-tables", "Туалетные столики", "Dressing tables"),
            ("Комплекты для спальни", "Bedroom Sets", "bedroom-sets", "Комплекты мебели для спальни", "Bedroom furniture sets"),
        ],
    ),
    (
        "Столовая и кухня",
        ...
        [
            ...
            ("Кухонные столы", "Kitchen Tables", "kitchen-tables", "Кухонные столы", "Kitchen tables"),
            ("Стулья", "Dining Chairs", "dining-chairs", "Обеденные стулья", "Dining chairs"),
            ("Комплекты столов и стульев", "Table and Chair Sets", "dining-sets", "Комплекты столов и стульев", "Table and chair sets"),
            ("Барные столы", "Bar Tables", "bar-tables", "Барные столы", "Bar tables"),
            ("Барные стулья", "Bar Stools", "bar-stools", "Барные стулья", "Bar stools"),
            ("Табуреты", "Stools", "stools", "Табуреты", "Stools"),
            ("Сервировочные столики", "Service Trolleys", "service-trolleys", "Сервировочные столики и тележки", "Service trolleys"),
    ...
    (
        ...
        "Home and office workspace furniture",
        [
            ...
            ("Тумбы с ящиками", "Drawer Units", "drawer-units", "Офисные тумбы с ящиками", "Drawer units"),
            ...
            ("Игровые столы", "Gaming Desks", "gaming-desks", "Столы для игровых зон", "Gaming desks"),
            ("Игровые кресла", "Gaming Chairs", "gaming-chairs", "Кресла для игровых зон", "Gaming chairs"),
        ],
    ),
    (
        ...
        "Children and Baby",
        "kids-furniture",
        "Мебель для детей и младенцев",
        "Children and baby furniture",
        [
            ("Детские кровати", "Kids Beds", "kids-beds", "Детские кровати", "Kids beds"),
            ("Двухъярусные кровати", "Bunk Beds", "bunk-beds", "Двухъярусные кровати", "Bunk beds"),
            ...
            ("Детские шкафы", "Kids Wardrobes", "kids-wardrobes", "Детские шкафы и гардеробы", "Kids wardrobes"),
            ("Детские комоды", "Kids Dressers", "kids-dressers", "Детские комоды", "Kids dressers"),
            ("Детские книжные шкафы", "Kids Bookcases", "kids-bookcases", "Детские книжные шкафы", "Kids bookcases"),
            ("Хранение игрушек", "Toy Storage", "toy-storage", "Шкафы и системы хранения игрушек", "Toy storage"),
        ],
    ),
    (
        "Хранение и прихожая",
        "Storage and Hallway",
        "storage-furniture",
        "Мебель для хранения и прихожей",
        "Storage and hallway furniture",
        [
            ...
            ("Открытые стеллажи", "Open Shelving Units", "open-shelving", "Открытые стеллажи", "Open shelving units"),
            ("Обувницы", "Shoe Cabinets", "shoe-cabinets", "Шкафы и тумбы для обуви", "Shoe cabinets"),
            ("Вешалки и гардеробные", "Coat Racks", "coat-racks", "Вешалки и решения для прихожей", "Coat racks and hallway storage"),
            ("Разделители помещений", "Room Dividers", "room-dividers", "Решения для разделения помещений", "Room divider solutions"),
        ],
    ),
    (
        "Ванная",
        ...
        "Bathroom furniture",
        [
            ("Шкафы для ванной", "Bathroom Cabinets", "bathroom-cabinets", "Шкафы для ванной комнаты", "Bathroom cabinets"),
            ("Высокие шкафы", "Bathroom Tall Cabinets", "bathroom-tall-cabinets", "Высокие шкафы для ванной", "Bathroom tall cabinets"),
            ("Тумбы под раковину", "Wash-basin Cabinets", "wash-basin-cabinets", "Тумбы под раковину", "Wash-basin cabinets"),
            ("Навесные шкафы", "Wall-mounted Bathroom Cabinets", "wall-mounted-bathroom-cabinets", "Навесные шкафы для ванной", "Wall-mounted bathroom cabinets"),
            ("Комплекты мебели", "Bathroom Furniture Sets", "bathroom-furniture-sets", "Комплекты мебели для ванной", "Bathroom furniture sets"),
        ],
    ),
    (
        "Сад и балкон",
        ...
        [
            ...
            ("Уличные диваны", "Outdoor Sofas", "outdoor-sofas", "Диваны для сада и балкона", "Outdoor sofas"),
            ("Уличные скамьи", "Outdoor Benches", "outdoor-benches", "Скамьи для сада и балкона", "Outdoor benches"),
