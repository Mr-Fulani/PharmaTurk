...
def create_test_data():
    ...
    Book.objects.create(
        ...
        price=899.99,
        old_price=1099.99,
        image='https://via.placeholder.com/300x400/4F46E5/FFFFFF?text=It',
        category=fiction,
        rating=4.5,
        reviews_count=1250,
        in_stock=True,
    ...
    Book.objects.create(
        ...
        price=1299.99,
        image='https://via.placeholder.com/300x400/F59E0B/FFFFFF?text=Business+Model',
        category=business,
        rating=4.6,
        reviews_count=890,
        in_stock=True,
    ...
    Book.objects.create(
        title='Сияние',
        slug='the-shining',
        description='История писателя и его семьи, зимующих в отеле с призраками',
        price=699.99,
        old_price=899.99,
        image='https://via.placeholder.com/300x400/EF4444/FFFFFF?text=The+Shining',
        category=fiction,
        rating=4.4,
        reviews_count=980,
        in_stock=True,
    ...
    Book.objects.create(
        ...
        price=899.99,
        old_price=1199.99,
        image='https://via.placeholder.com/300x400/8B5CF6/FFFFFF?text=Homo+Deus',
        category=science,
        rating=4.7,
        reviews_count=2150,
        in_stock=True,
