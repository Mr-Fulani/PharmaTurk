...
export default function Footer() {
  ...
  return (
    <footer className="mt-10 border-t border-[var(--border)] bg-[var(--surface)] shadow-xl transition-colors duration-200">
          ...
          <div className="flex justify-center sm:justify-start">
            <div>
              ...
              <div className="flex items-center gap-3">
                <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-main bg-surface transition hover:-translate-y-0.5 hover:bg-surface/70 hover:shadow-md" aria-label="Telegram">
                ...
                <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-main bg-surface transition-all duration-200 hover:-translate-y-0.5 hover:bg-surface/70 hover:shadow-md" aria-label="WhatsApp">
                ...
                <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-main bg-surface transition-all duration-200 hover:-translate-y-0.5 hover:bg-surface/70 hover:shadow-md" aria-label="VK">
                ...
                <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-main bg-surface transition-all duration-200 hover:-translate-y-0.5 hover:bg-surface/70 hover:shadow-md" aria-label="Instagram">
