export default function Footer() {
  return (
    <footer className="mt-10 border-t border-violet-100 bg-gradient-to-b from-white/90 to-white">
      <div className="mx-auto max-w-7xl px-6 py-10 text-sm text-gray-700">
        <div className="grid grid-cols-1 items-start gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <a href="tel:+905550000000" className="group flex items-center gap-2 transition hover:-translate-y-0.5">
              ...
              <a href="mailto:info@turk-export.example" className="group flex items-center gap-2 transition hover:-translate-y-0.5">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="text-violet-700 transition group-hover:scale-110">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-violet-200 bg-white transition hover:-translate-y-0.5 hover:bg-violet-50 hover:shadow-md" aria-label="WhatsApp">
              ...
              <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-violet-200 bg-white transition hover:-translate-y-0.5 hover:bg-violet-50 hover:shadow-md" aria-label="VK">
              ...
              <a href="#" className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-violet-200 bg-white transition hover:-translate-y-0.5 hover:bg-violet-50 hover:shadow-md" aria-label="Instagram">
