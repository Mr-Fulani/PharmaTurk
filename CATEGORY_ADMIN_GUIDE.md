...
> **Примечание:** При первом запуске backend команда `seed_catalog_data` автоматически создаёт полную структуру каталога (18 корневых категорий, подкатегории с иерархией L2–L5, включая услуги, атрибуты и бренды). Ручное создание через админку нужно только для добавления новых категорий или изменения существующих.
...
- [CATALOG_ADMIN_ACTIONS_GUIDE.md](/Users/user/PharmaTurk/CATALOG_ADMIN_ACTIONS_GUIDE.md)
