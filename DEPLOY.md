...
- PostgreSQL `15.18`, Redis `7.4.10` и Qdrant `1.18.3`;
...
не переходите прямо на `1.18.3`: сначала поднимите последний `1.15.x`, затем
`1.16.x`, проверьте данные и только после этого переходите на `1.18.3`. На
